...
def level_parser(xp: Optional[int] = None, level: Optional[int] = None) -> LevelTuple:
    """
    Takes either xp OR level and returns the value for the other
    """

    levels: List[LevelTuple] = [
    ...
    if xp is not None:
        for level in levels:
            if level.total_xp <= xp < (level.total_xp + level.xp_required):
                return level
    if level:
        return next((x for x in levels if x.level == level), None)
    else:
        raise ValueError
...
BADGES = [
    {"name": "badge_travel_km", "bronze": 10, "silver": 100, "gold": 1000, "platinum": 10000},
    {"name": "badge_pokedex_entries", "bronze": 5, "silver": 50, "gold": 100, "platinum": 151},
    {"name": "badge_capture_total", "bronze": 30, "silver": 500, "gold": 2000, "platinum": 50000},
    {"name": "badge_evolved_total", "bronze": 3, "silver": 20, "gold": 200, "platinum": 2000},
    {"name": "badge_hatched_total", "bronze": 10, "silver": 100, "gold": 500, "platinum": 2500},
    {
    ...
    {"name": "badge_big_magikarp", "bronze": 3, "silver": 50, "gold": 300, "platinum": 1000},
    {
    ...
    {"name": "badge_small_rattata", "bronze": 3, "silver": 50, "gold": 300, "platinum": 1000},
    {"name": "badge_pikachu", "bronze": 3, "silver": 50, "gold": 300, "platinum": 1000},
    ...
    {"name": "badge_pokedex_entries_gen4", "bronze": 5, "silver": 30, "gold": 80, "platinum": 107},
    ...
    {"name": "badge_pokemon_purified", "bronze": 5, "silver": 50, "gold": 500, "platinum": 1000},
    {
    ...
    {"name": "badge_buddy_best", "bronze": 1, "silver": 10, "gold": 100, "platinum": 2000},
    {"name": "badge_wayfarer", "bronze": 50, "silver": 500, "gold": 1000, "platinum": 1500},
    {"name": "badge_total_mega_evos", "bronze": 1, "silver": 50, "gold": 500, "platinum": 1000},
    {"name": "badge_unique_mega_evos", "bronze": 1, "silver": 24, "gold": 36, "platinum": 46},
    {
