...
class BaseCommunity(models.Model):
	...
	regions = models.ManyToManyField(Region, blank=True, verbose_name=_("Regions"))
	subregions = models.ManyToManyField(Subregion, blank=True, verbose_name=_("Subregions"))
	cities = models.ManyToManyField(City, blank=True, verbose_name=_("Cities"))
	districts = models.ManyToManyField(District, blank=True, verbose_name=_("Districts"))
