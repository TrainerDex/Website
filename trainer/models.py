...
class Update(models.Model):
	...
	dex_caught = models.PositiveIntegerField(null=True, blank=True)
	dex_seen = models.PositiveIntegerField(null=True, blank=True)
	walk_dist = models.DecimalField(max_digits=16, decimal_places=1, null=True, blank=True)
	gen_1_dex = models.PositiveIntegerField(null=True, blank=True)
	pkmn_caught = models.PositiveIntegerField(null=True, blank=True)
	pkmn_evolved = models.PositiveIntegerField(null=True, blank=True)
	pkstops_spun = models.PositiveIntegerField(null=True, blank=True)
	battles_won = models.PositiveIntegerField(null=True, blank=True)
	gen_2_dex = models.PositiveIntegerField(null=True, blank=True)
	berry_fed = models.PositiveIntegerField(null=True, blank=True)
	gym_defended = models.PositiveIntegerField(null=True, blank=True)
	eggs_hatched = models.PositiveIntegerField(null=True, blank=True)
	big_magikarp = models.PositiveIntegerField(null=True, blank=True)
	legacy_gym_trained = models.PositiveIntegerField(null=True, blank=True)
	tiny_rattata = models.PositiveIntegerField(null=True, blank=True)
	pikachu_caught = models.PositiveIntegerField(null=True, blank=True)
	unown_alphabet = models.PositiveIntegerField(null=True, blank=True)
	raids_completed = models.PositiveIntegerField(null=True, blank=True)
	#Pokemon-demographics
	pkmn_normal = models.PositiveIntegerField(null=True, blank=True)
	pkmn_flying = models.PositiveIntegerField(null=True, blank=True)
	pkmn_poison = models.PositiveIntegerField(null=True, blank=True)
	pkmn_ground = models.PositiveIntegerField(null=True, blank=True)
	pkmn_rock = models.PositiveIntegerField(null=True, blank=True)
	pkmn_bug = models.PositiveIntegerField(null=True, blank=True)
	pkmn_steel = models.PositiveIntegerField(null=True, blank=True)
	pkmn_fire = models.PositiveIntegerField(null=True, blank=True)
	pkmn_water = models.PositiveIntegerField(null=True, blank=True)
	pkmn_grass = models.PositiveIntegerField(null=True, blank=True)
	pkmn_electric = models.PositiveIntegerField(null=True, blank=True)
	pkmn_psychic = models.PositiveIntegerField(null=True, blank=True)
	pkmn_dark = models.PositiveIntegerField(null=True, blank=True)
	pkmn_fairy = models.PositiveIntegerField(null=True, blank=True)
	pkmn_fighting = models.PositiveIntegerField(null=True, blank=True)
	pkmn_ghost = models.PositiveIntegerField(null=True, blank=True)
	pkmn_ice = models.PositiveIntegerField(null=True, blank=True)
	pkmn_dragon = models.PositiveIntegerField(null=True, blank=True)
	#Other stats
