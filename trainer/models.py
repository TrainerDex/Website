...
class Trainer(models.Model):
	...
	faction = models.ForeignKey('Faction', on_delete=models.SET_DEFAULT, default=0)
...
class Discord_Server(models.Model):
	...
	s_owner = models.ForeignKey('Discord_User', on_delete=models.SET_NULL, null=True, blank=True)
...
class Discord_Relation(models.Model):
	d_id = models.ForeignKey('Discord_User', on_delete=models.CASCADE)
	d_server = models.ForeignKey('Discord_Server', on_delete=models.CASCADE)
