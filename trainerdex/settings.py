...
STRIPE_LIVE_PUBLIC_KEY = os.environ.get(
    ...
    "pk_live_51Hk8pmJwllNAygCzuYHyp9kyau6mTYfVOSYTssfKshVOfKF7HznbcjnYcVAvrMXa7UoH67xdE61k3UNvo06bekyK00gBZfhOSY",
)
STRIPE_LIVE_SECRET_KEY = os.environ.get(
    "STRIPE_LIVE_SECRET_KEY",
    "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",
)
STRIPE_TEST_PUBLIC_KEY = os.environ.get(
    "STRIPE_TEST_PUBLIC_KEY",
    "pk_test_51Hk8pmJwllNAygCzRFeTAYHzQscGgLqQiG0ajVEMlapwE5mK91VvRAIRJrRPPQ5Cno12iA5RetFDm4t2bYispb9r00BLgtXJMF",
)
STRIPE_TEST_SECRET_KEY = os.environ.get(
    "STRIPE_TEST_SECRET_KEY",
    "sk_test_51Hk8pmJwllNAygCzX4OICQ3X6WjxyYE9djtkZoF1SpCEnzipia7mHHJj64tDDgP5yS3CVC858Ge4fbOBGIxtJ3HK003aq5zmqM",
)
STRIPE_LIVE_MODE = not DEBUG
DJSTRIPE_WEBHOOK_SECRET = "whsec_DRIJwX6z8jcWBnu0QQKGd5YdE5bqFSWH"
